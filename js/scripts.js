  ...
  http://stackoverflow.com/questions/2104949/how-to-reload-refresh-an-elementimage-in-jquery
    */
    ...
    if (window.matchMedia("(min-width: 1px)").matches) {
      ...
      $c1.attr("src", "img/d338x254/1.jpg");
      $c2.attr("src", "img/d338x254/2.jpg");
      $c3.attr("src", "img/d338x254/3.jpg");
      $c4.attr("src", "img/d338x254/4.jpg");
    }
    ...
    if (window.matchMedia("(min-width: 768px)").matches) {
      ...
      $c1.attr("src", "img/d512x384/1.jpg");
      $c2.attr("src", "img/d512x384/2.jpg");
      $c3.attr("src", "img/d512x384/3.jpg");
      $c4.attr("src", "img/d512x384/4.jpg");
    }
    ...
    if (window.matchMedia("(min-width: 992px)").matches) {
      ...
      $c1.attr("src", "img/d768x576/1.jpg");
      $c2.attr("src", "img/d768x576/2.jpg");
      $c3.attr("src", "img/d768x576/3.jpg");
      $c4.attr("src", "img/d768x576/4.jpg");
    }
    ...
    if (window.matchMedia("(min-width: 1200px)").matches) {
      ...
      $c1.attr("src", "img/d1024x768/1.jpg");
      $c2.attr("src", "img/d1024x768/2.jpg");
      $c3.attr("src", "img/d1024x768/3.jpg");
      $c4.attr("src", "img/d1024x768/4.jpg");
    }
